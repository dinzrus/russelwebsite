...
export default function EditBlogPost({ data }: PageProps<EditData>) {
  if (data.notFound) {
    return (
      <DashboardLayout title="Edit Post" activeNav="blog">
        <p class="text-slate-500 dark:text-slate-400">Post not found.</p>
      </DashboardLayout>
    );
  }
